(()=>{
  ...
  window.FitConnectProductRenderer={init,openEditor,render:()=>renderInitial(store?.getState().products||[]),ProductCardFactory,ProductFormFactory};
