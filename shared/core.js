  ...
  async function boot(){
    ...
    try{
      ...
      await Promise.all([
        ...
        assets.productCatalogUiCss?loadStyle(assets.productCatalogUiCss,'fc-product-catalog-ui-css',version):Promise.resolve(),
        assets.inventoryUiCss?loadStyle(assets.inventoryUiCss,'fc-inventory-ui-css',version):Promise.resolve(),
      ...
      for(const [key,id] of [['profileModelJs','fc-profile-model-js'],['userServiceJs','fc-user-service-js'],['authStateJs','fc-auth-state-js'],['sessionManagerJs','fc-session-manager-js'],['permissionsJs','fc-permissions-js'],['routeGuardJs','fc-route-guard-js'],['authFlowsJs','fc-auth-flows-js'],['authCallbackJs','fc-auth-callback-js'],['accountDashboardJs','fc-account-dashboard-js'],['userSettingsJs','fc-user-settings-js'],['profileEditorJs','fc-profile-editor-js'],['accountShellJs','fc-account-shell-js'],['securityEventsJs','fc-security-events-js'],['businessCoreJs','fc-business-core-js'],['workspaceJs','fc-workspace-js'],['businessSettingsJs','fc-business-settings-js'],['modulesJs','fc-modules-js'],['businessUiJs','fc-business-ui-js'],['contactModelJs','fc-contact-model-js'],['companyModelJs','fc-company-model-js'],['leadModelJs','fc-lead-model-js'],['timelineJs','fc-timeline-js'],['tasksJs','fc-tasks-js'],['labelsJs','fc-labels-js'],['crmSearchJs','fc-crm-search-js'],['crmJs','fc-crm-js'],['crmUiJs','fc-crm-ui-js'],['crmPipelineJs','fc-crm-pipeline-js'],['crmDetailJs','fc-crm-detail-js'],['contactServiceJs','fc-contact-service-js'],['companyServiceJs','fc-company-service-js'],['leadServiceJs','fc-lead-service-js'],['bulkServiceJs','fc-bulk-service-js'],['recycleBinJs','fc-recycle-bin-js'],['csvImportJs','fc-csv-import-js'],['csvExportJs','fc-csv-export-js'],['notificationsJs','fc-notifications-js'],['contactFormJs','fc-contact-form-js'],['companyFormJs','fc-company-form-js'],['leadFormJs','fc-lead-form-js'],['pipelineDndJs','fc-pipeline-dnd-js'],['bulkToolbarJs','fc-bulk-toolbar-js'],['recycleBinUiJs','fc-recycle-bin-ui-js'],['importWizardJs','fc-import-wizard-js'],['exportWizardJs','fc-export-wizard-js'],['productModelJs','fc-product-model-js'],['productCategoriesJs','fc-product-categories-js'],['productVariantsJs','fc-product-variants-js'],['pricingEngineJs','fc-pricing-engine-js'],['taxConfigJs','fc-tax-config-js'],['productMediaJs','fc-product-media-js'],['productSearchJs','fc-product-search-js'],['productServiceJs','fc-product-service-js'],['productCatalogJs','fc-product-catalog-js'],['productDashboardJs','fc-product-dashboard-js'],['productListJs','fc-product-list-js'],['productFiltersJs','fc-product-filters-js'],['productFormJs','fc-product-form-js'],['categoryManagerJs','fc-category-manager-js'],['variantEditorJs','fc-variant-editor-js'],['pricingEditorJs','fc-pricing-editor-js'],['productMediaUiJs','fc-product-media-ui-js'],['productBulkJs','fc-product-bulk-js'],['warehouseModelJs','fc-warehouse-model-js'],['warehouseServiceJs','fc-warehouse-service-js'],['inventoryStockJs','fc-inventory-stock-js'],['inventoryMovementsJs','fc-inventory-movements-js'],['inventoryReservationsJs','fc-inventory-reservations-js'],['inventoryCountsJs','fc-inventory-counts-js'],['inventoryValuationJs','fc-inventory-valuation-js'],['inventoryCoreJs','fc-inventory-core-js'],['inventoryDashboardJs','fc-inventory-dashboard-js'],['warehouseManagerJs','fc-warehouse-manager-js'],['inventoryListJs','fc-inventory-list-js'],['inventoryAvailabilityJs','fc-inventory-availability-js'],['inventoryMovementFormJs','fc-inventory-movement-form-js'],['inventoryMovementHistoryJs','fc-inventory-movement-history-js'],['inventoryReservationsUiJs','fc-inventory-reservations-ui-js'],['inventoryLowStockJs','fc-inventory-low-stock-js'],['inventoryCountWizardJs','fc-inventory-count-wizard-js'],['inventoryValuationReportJs','fc-inventory-valuation-report-js'],['themeJs','fc-theme-js'],['typographyJs','fc-typography-js'],['iconsJs','fc-icons-js'],['overlaysJs','fc-overlays-js'],['componentsJs','fc-components-js'],['advancedComponentsJs','fc-advanced-components-js'],['dataComponentsJs','fc-data-components-js'],['accessibilityJs','fc-accessibility-js'],['designSystemRuntimeJs','fc-design-system-runtime-js'],['publicNavJs','fc-public-nav-js']])if(assets[key])await loadScript(assets[key],id,version);
      ...
      window.FitConnectProductDashboard?.mount?.();
      window.FitConnectProductList?.mount?.();
      window.FitConnectProductFilters?.mount?.();
      window.FitConnectProductForm?.mount?.();
      window.FitConnectCategoryManager?.mount?.();
      window.FitConnectVariantEditor?.mount?.();
      window.FitConnectPricingEditor?.mount?.();
      window.FitConnectProductMediaUI?.mount?.();
      window.FitConnectProductBulk?.mount?.();
      window.FitConnectInventoryDashboard?.mount?.();
      window.FitConnectWarehouseManager?.mount?.();
      window.FitConnectInventoryList?.mount?.();
      window.FitConnectInventoryAvailability?.mount?.();
      window.FitConnectInventoryMovementForm?.mount?.();
      window.FitConnectInventoryMovementHistory?.mount?.();
      window.FitConnectInventoryReservationsUI?.mount?.();
      window.FitConnectInventoryLowStock?.mount?.();
      window.FitConnectInventoryCountWizard?.mount?.();
      window.FitConnectInventoryValuationReport?.mount?.();
